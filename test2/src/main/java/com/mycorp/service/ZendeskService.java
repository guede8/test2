...
public class ZendeskService {
	...
	public String altaTicketZendesk(UsuarioAlta usuarioAlta, String userAgent) {
		...
		datosUsuario = this.buildForm(usuarioAlta, userAgent);
		...
		getClientId(usuarioAlta, restTemplate, clientName, idCliente, datosServicio, mapper);

		// Obtiene los datos de cliente
		getDatosCliente(datosBravo, idCliente, restTemplate);
